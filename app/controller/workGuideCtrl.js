App.controller('workGuideCtrl', ['$scope', 'PcService', '$rootScope', 'serverUrls', '$q', '$stateParams', '$location', '$http', 'ngDialog', 'PagerExtends', 'layerAlert',
			...
			ngDialog.openConfirm({
				...
				controller: ['$scope', function($scope) {
					...
					$scope.formSubmit = function() {
						PcService.formSubmit($scope, false, $scope.fieldsList, serverUrls.upGuide, x, {}, $rootScope.pHeader);
					};
