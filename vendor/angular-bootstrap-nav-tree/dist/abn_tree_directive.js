			...
			return {
				...
				link: function(scope, element, attrs) {
					...
					if(attrs.iconLeaf == null) {
						attrs.iconLeaf = 'icon-file  glyphicon glyphicon-file  fa fa-building';
					}
					...
					var selected_branchCallback = function(isSame, branch) {
						if(isSame) {
					...
					select_branch = function(branch, isFirst, isInit) {

						scope.$parent.for_each_branch = for_each_branch;
						if(!branch) {
						...
						if(branch !== selected_branch) {
							...
							if(branch.onSelect != null) {
								return $timeout(function() {
									return branch.onSelect(branch, isFirst, selected_branchCallback, isInit);
								});
							} else {
					...
					if(attrs.initialSelection != null) {
						for_each_branch(function(b) {
							if(b.label === attrs.initialSelection) {
								return $timeout(function() {
									return select_branch(b, true, true);
								});
							}
						});
					}
